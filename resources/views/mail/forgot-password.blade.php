            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="padding-top: 30px;padding-bottom: 5px;mso-table-lspace: 0; mso-table-rspace: 0; background-color: #222222;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="your-logo"
                                                                        src="{{ $message->embed(asset('images/logo.png')) }}"
                                                                        style="display: block; height: auto; border: 0; width: 125px; max-width: 100%;"
                                                                        title="your-logo" width="125" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </th>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2"
                        role="presentation" style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #222222;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        class="big"
                                                                        src="{{ $message->embed(asset('images/mail/Top.png')) }}"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
                        role="presentation"
                        style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #222222;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="reset-password"
                                                                        src="{{ $message->embed(asset('images/mail/pass-animate.gif')) }}"
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    ...
                                                                    <a href="{{ $user_data['link'] ?? '' }}"
                                                                        style="text-decoration:none;display:inline-block;color:#393d47;background-color:#ffc727;border-radius:20px;width:auto;border-top:1px solid #FFC727;border-right:1px solid #FFC727;border-bottom:1px solid #FFC727;border-left:1px solid #FFC727;padding-top:10px;padding-bottom:10px;font-family:Tahoma, Verdana, Segoe, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        class="big"
                                                                        src="{{ $message->embed(asset('images/mail/Btm.png')) }}"
                                                                        style="display: block; height: auto; border: 0; width: 500px; max-width: 100%;"
                                                                        width="500" /></div>
                                                            </td>
                                                        </tr>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-5"
                        role="presentation"
                        style="mso-table-lspace: 0; mso-table-rspace: 0; background-color: #222222;padding-bottom: 30px;padding-top: 30px;"
                        width="100%">
                        {{-- <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        style="font-size: 12px; font-family: Tahoma, Verdana, Segoe, sans-serif; color: #393d47; line-height: 1.2;">
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            <span style="font-size:10px;">This link
                                                                                will expire in 1 hours. If you continue
                                                                                to have problems</span><br /><span
                                                                                style="font-size:10px;">please feel
                                                                                free to contact us at <a
                                                                                    href="mailto:support@youremail.com"
                                                                                    rel="noopener"
                                                                                    style="text-decoration: underline; color: #393d47;"
                                                                                    target="_blank"
                                                                                    title="support@youremail.com">support@youremail.com</a>.
                                            ...
                                            <tr>
                                                <td style="text-align:center;padding-right:0px;padding-left:0px">
                                                    <table align="center" border="0" cellpadding="0"
                                                        cellspacing="0" role="presentation" width="168px">
                                                        <tbody>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <span
                                                                        style="font-size: 25px;font-weight: 500;color: white;">Available
                                                                        On</span>
                                                                    <br><br>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td style="padding:0 5px 0 5px">
                                                                    <a href="javascript:void(0)" target="_blank">
                                                                        <img alt="Facebook" height="32"
                                                                            src="{{ $message->embed(asset('images/mail/android.png')) }}"
                                                                            style="display:block;height:auto;border:0;width: 238px;height:70px;"
                                                                            title="Facebook" width="230"
                                                                ...
                                                                <td style="padding:0 5px 0 5px">
                                                                    <a href="javascript:void(0)" target="_blank">
                                                                        <img alt="Twitter" height="32"
                                                                            src="{{ $message->embed(asset('images/mail/apple.png')) }}"
                                                                            style="display:block;height:auto;border:0;width: 238px;height:70px;"
                                                                            title="Twitter" width="230"
                                                                            data-image-whitelisted="" class="CToWUd">
                                                                    </a>
                                                                </td>
                                                            </tr>
