    ...
    <div class="content-inner">
            ...
            <div class="page-header-content header-elements-lg-inline">
                ...
                <div class="header-elements d-none">
                    <div class="d-flex justify-content-center">
                        ...
                        <!-- <a href="{{ route('interview-video.create') }}" type="button" class="btn btn-primary ml-1">Add</a> -->
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('interview-video-question.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input name="question" class="form-control form-control-lg" type="text" placeholder="Question" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <textarea name="answer" class="form-control form-control-lg" placeholder="Answer" rows="7" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
