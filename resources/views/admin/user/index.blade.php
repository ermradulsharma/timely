                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('user.show', [$value['id'], 'page' => $data['page']]) }}" class="dropdown-item"><i class="icon-eye"></i>Detail</a>
                                        <a href="{{ route('user.jobs', [$value['id'], 'page' => $data['page']]) }}" class="dropdown-item"><i class="icon-notebook"></i>Applied Jobs</a>
                                    </div>
                                </div>
                            </div>
                        </td>
