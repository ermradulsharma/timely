    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('categories.update', [$data['id']]) }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="page_number" value="{{ $data['page'] ?? 1 }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input name="name" class="form-control form-control-lg" type="text" placeholder="Name" value="{{ $data['name'] }}" required>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <img class="img-fluid" id="preview-field" src="{{ $data['image'] ?? '' }}" width="150" height="150" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
