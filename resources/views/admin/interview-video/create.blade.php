        ...
        <div class="content-inner">
            ...
            <div class="content">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('interview-video.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row" id="preview-wrapper" style="display: none;">
                                <label class="col-form-label col-lg-2"></label>
                                <div class="col-lg-10">
                                    <div class="row">
                                        <div class="col-lg-6">
                                                ...
                                                <div class="card-img-actions">
                                                    <div class="card-img embed-responsive embed-responsive-16by9">
                                                        <video width="320" height="240" controls>
                                                            <source src="" id="interview-video-preview">
