    ...
    <div class="page-header-content header-elements-lg-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <a href="{{ route('contract-type.create') }}" type="button"
                    class="btn btn-primary ml-1">Add</a>
                <form style="margin-left: 5px;" action="{{ route('contract-type.index') }}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="list-icons">
                                <a href="{{ route('contract-type.edit', [$value['id'], 'page' => $data['page']]) }}"
                                    class="list-icons-item text-primary"><i
                                        class="icon-pencil7"></i></a>
                                <a href="{{ route('contract-type.delete', [$value['id'], 'page' => $data['page']]) }}"
