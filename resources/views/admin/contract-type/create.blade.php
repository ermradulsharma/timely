    ...
    <div class="page-header-content header-elements-lg-inline">
        ...
        <div class="header-elements d-none">
            <div class="d-flex justify-content-center">
                <a href="{{ route('contract-type.index') }}" type="button" class="btn btn-primary">Back</a>
            </div>
        </div>
    </div>
</div>
...
<div class="content">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('contract-type.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
